...
public class KidFriendly extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        words.add(new Word(getString(R.string.nSC), getString(R.string.r4_5), getString(R.string.games),
                R.drawable.nationalsciencecentre));
        words.add(new Word(getString(R.string.cP), getString(R.string.r4_4), getString(R.string.swings), R.drawable.childrenpark));
        ...
        words.add(new Word(getString(R.string.aI), getString(R.string.r4_2), getString(R.string.adventures),
                R.drawable.adventureisland));
